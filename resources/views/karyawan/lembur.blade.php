    ...
    <div class="card-body">
        <div class="row align-items-center no-gutters">
            ...
            <div class="col-auto">
                ...
                @else
                <form action="{{ url('/karyawan/lembur/'.$a->id) }}" method="POST">
                    @csrf
...
<div class="card shadow mt-4">
    <div class="card-header py-3">
        <p class="text-center text-primary m-0 font-weight-bold">Daftar Lembur</p>
    </div>
    <div class="card-body">
        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
            <table class="table dataTable my-0 table-striped" id="lembur_table">
                <thead>
                    <tr>
