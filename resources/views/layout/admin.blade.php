    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="{{ url('/admin') }}">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ ($active == 0 ? "active" : "") }}" href="{{ url('/admin') }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ ($active == 1 ? "active" : "") }}" href="{{ url('/admin/karyawan') }}">
                            <i class="fa fa-user"></i>
                            <span>&nbsp;Karyawan</span>
                        </a>
                        <a class="nav-link {{ ($active == 2 ? "active" : "") }}" href="{{ url('/admin/gaji') }}">
                            <i class="fa fa-money"></i>
                            <span>&nbsp;Gaji Karyawan</span>
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ ($active == 3 ? "active" : "") }}" href="{{ url('/admin/laporan') }}">
                            ...
                            <li class="nav-item dropdown no-arrow" role="presentation">
                                <div class="nav-item dropdown no-arrow">
                                    ...
                                    <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in" role="menu">
                                        <a class="dropdown-item" role="presentation" href="{{ url('/admin/profile') }}">
