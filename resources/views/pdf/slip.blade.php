                ...
                <table border="0" style="height: 50px; width: 100%; border-collapse: collapse;">
                    <tbody>
                        <tr style="height: 50px;">
                            ...
                            <td style="width: 33.3333%; height: 50px;">
                                <p style="font-size: 15px; margin-top: 0px; margin-bottom: 0px">Tanggal&nbsp; &nbsp; &nbsp; &nbsp; :</p>
                                <p style="font-size: 15px; margin-top: 3px; margin-bottom: 0px">ID Gaji&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;:</p>
                                <p style="font-size: 15px; margin-top: 3px; margin-bottom: 0px">ID Pegawai &nbsp; :</p>
                            </td>
                        </tr>
                        <tr>
                                                                ...
                                                                <table border="0" style="height: 60px; width: 100%; border-collapse: collapse;">
                                                                    <tbody>
                                                                        <tr style="height: 20px;">
                                                                            ...
                                                                            <td style="width: 40.2845%; height: 20px; text-align: left;">Rp 75.000,00</td>
                                                                        </tr>
                                                                        <tr style="height: 20px;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 40.2845%; text-align: left;">Rp 75.000,00</td>
                                                                        </tr>
                                                                        <tr>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td style="width: 28.0563%; text-align: center">
                                                                                                ...
                                                                                                <p style="margin-top: 100px">Nama</p>
                                                                                            </td>
                                                                                            <td style="width: 31.7501%;">
                                                                                                <p style="text-align: right;margin-bottom: 203px"><strong>TOTAL DITERIMA</strong></p>
                                                                                            </td>
                                                                                            <td style="width: 40.1935%;">
                                                                                                <p style="text-align: left;margin-bottom: 50px; margin-left: 25px">Rp 75.000,00</p>
                                                                                                <p style="text-align: center;margin-top: 50px">Sumedang, 13 Oktober 2020</p>
